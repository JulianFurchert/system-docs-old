...
const createPalette = hex => {
  let hsluv = hexToHsluv(hex);
  return {
    "0": hexToRgba( hsluvToHex([ hsluv[0], hsluv[1], 80 ]), 0 ),
    "01": hexToRgba( hsluvToHex([ hsluv[0], hsluv[1], 80 ]), 0.1 ),
    "02": hexToRgba( hsluvToHex([ hsluv[0], hsluv[1], 80 ]), 0.2 ),
    "03": hexToRgba( hsluvToHex([ hsluv[0], hsluv[1], 80 ]), 0.3 ),
    "04": hexToRgba( hsluvToHex([ hsluv[0], hsluv[1], 80 ]), 0.4 ),
    "1": hex,
    ...( hsluv[2] < 65 ? { "on": "#FFFFFF"} : { "on": "#151515"} ),
    ...( hsluv[2] < 65 ? {
      "2": hsluvToHex([ hsluv[0], hsluv[1], hsluv[2] - 5 ]),
      "3": hsluvToHex([ hsluv[0], hsluv[1], hsluv[2] - 10 ]),
    } : {
      "2": hsluvToHex([ hsluv[0], hsluv[1], hsluv[2] + 5 ]),
      "3": hsluvToHex([ hsluv[0], hsluv[1], hsluv[2] + 10 ]),
    }),
    "inactive": hsluvToHex([ hsluv[0], hsluv[1], 50 ]),
  }
}
